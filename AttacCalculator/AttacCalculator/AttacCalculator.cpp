...
// AttacCalculator.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CAttacCalculatorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CAttacCalculatorApp

CAttacCalculatorApp::CAttacCalculatorApp()
{
...
// Единственный объект CAttacCalculatorApp

CAttacCalculatorApp theApp;


// Инициализация CAttacCalculatorApp

BOOL CAttacCalculatorApp::InitInstance()
{
